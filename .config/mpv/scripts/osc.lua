...
local user_opts = {
    ...
    seekpause = false,          -- automatically pause on seek
    ...
    colorosc = false,          -- enable light theme for osc
}
...
local osc_styles = {
    ...
    box = "{\\rDefault\\blur0\\bord1\\1c&H00000\\3c&HFFFFFF}",
    ...
    timePosBar = "{\\blur0\\bord".. user_opts.tooltipborder .."\\1c&HFFFFFF\\3c&211a19\\fs30}",
...
function set_osc_color ()
    osc_styles.bigButtons =         "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs50\\fnmpv-osd-symbols}"
    osc_styles.smallButtonsL =      "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs19\\fnmpv-osd-symbols}"
    osc_styles.smallButtonsR =      "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs30\\fnmpv-osd-symbols}"
    osc_styles.topButtons =         "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs12\\fnmpv-osd-symbols}"
    osc_styles.timecodes =          "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs20}"
    osc_styles.vidtitle =           "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs12\\q2}"
    osc_styles.box =                "{\\rDefault\\blur0\\bord0\\1c&f993bd\\3c&HFFFFFF}"
    osc_styles.topButtonsBar =      "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs18\\fnmpv-osd-symbols}"
    osc_styles.smallButtonsBar =    "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs28\\fnmpv-osd-symbols}"
    osc_styles.timecodesBar =       "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs27}"
    osc_styles.timePosBar =         "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs30}"
    osc_styles.vidtitleBar =        "{\\blur0\\bord0\\1c&211a19\\3c&211a19\\fs18\\q2}"
    osc_styles.wcButtons =          "{\\1c&211a19\\fs24\\fnmpv-osd-symbols}"
    osc_styles.wcTitle =            "{\\1c&211a19\\fs24\\q2}"
    osc_styles.wcBar =              "{\\1c&211a19}"
end
...
layouts["slimbox"] = function ()
    ...
    -- styles
    local styles = {
        box = "{\\rDefault\\blur0\\bord1\\1c&211a19\\3c&HFFFFFF}",
        timecodes = "{\\1c&HFFFFFF\\3c&211a19\\fs20\\bord2\\blur1}",
        tooltip = "{\\1c&HFFFFFF\\3c&211a19\\fs12\\bord1\\blur0.5}",
    }
...
function osc_init()
    ...
    ne.eventresponder["mbtn_left_down"] = --exact seeks on single clicks
        function (element)
            ...
            if user_opts.seekpause then
                mp.set_property_bool("pause", "yes") -- pause when seeking
            end
        end
